...
const translations = reactive({
  en: {
    ...
    wssReportTip: 'Enabling WSS reduces Workers requests and increases real-time performance, but it can use 85% of Durable Objects duration regardless of server count. Recommended to enable when no other projects are using Durable Objects.',
  ...
  zh: {
    ...
    wssReportTip: '开启 WSS 可减少 Workers 请求量，增加实时性；会占用 85% Durable Objects 时长消耗（和服务器数量无关），无其他项目占用的情况下，建议开启。',
