...
const CHART_DEFS = [
  ...
  { key: 'ping', ref: () => pingChartRef.value, datasets: [ds('VNPT', '#00d4aa', { tension: 0.3 }), ds('VIETTEL', '#ffb870', { tension: 0.3 }), ds('FPT', '#4da6ff', { tension: 0.3 }), ds('OTHER', '#b392f0', { tension: 0.3 })], unit: ' ms', legend: true },
  { key: 'loss', ref: () => lossChartRef.value, datasets: [ds('VNPT', '#00d4aa', { tension: 0.3 }), ds('VIETTEL', '#ffb870', { tension: 0.3 }), ds('FPT', '#4da6ff', { tension: 0.3 }), ds('OTHER', '#b392f0', { tension: 0.3 })], unit: '%', legend: true },
